# utl_selecting-teams-that-have-at-least-one-male-and-female-player
    ...
    Eight Solutions                                                                                                     
        ...
        f. Simplified merge                                                                                             
           ...
           Faster because first.sex is slower and no need for two level by statement;                                   
    ...
    This why I use SAS as my base system, clarity, flexibility and speed.                                               
    ...
    *_          _           _                                                                                           
    ...
    data want;                                                                                                          
      ...
      _RC_ = HoH.defineKey("id");                                                                                       
      _RC_ = HoH.defineData("id","H");                                                                                  
      _RC_ = HoH.defineDone();                                                                                          
      declare hiter I("HoH");                                                                                           
      ...
      do while (I.next() = 0);                                                                                          
        if H.num_items > 1 then output; keep ID;                                                                        
      end;                                                                                                              
      stop;                                                                                                             
    run;                                                                                                                
